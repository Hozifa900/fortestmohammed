...
import img12 from "../../assets/images/home.svg"
  ...
  return (
    <header className="header">
      <div className="logo">
        ...
        <span style={{fontSize:"38px", color:"#081836",fontFamily:"Frutiger LT Pro"}}>Logo</span>
      </div>
          ...
          <div className="admin-profile">
            ...
            >
              ...
              <div className="profile-info">
                <span style={{fontSize:"20px",fontFamily:"Frutiger LT Pro", color:"#0C1834"}}>John Doe</span>
                <span style={{fontSize:"16px", color:"#687599",fontFamily:"Frutiger LT Pro" }}>Admin</span>
              </div>
          ...
          <div className={`dropdown-content-profile ${isOpen ? "show" : ""}`}>
            <div className="admin-option">
              <a href="#">
                ...
                <span className="admin-text">My Account</span><span style={{color:"#65769C",  marginLeft: "auto"}} >&gt;</span>
              </a>
            </div>
            ...
            <div className="admin-option">
              <a href="#">
                ...
                <span className="admin-text">Settings</span><span style={{color:"#65769C",  marginLeft: "auto"}} >&gt;</span>
              </a>
            </div>
            <div className="admin-option">
              <a href="#">
                <img src={img11} style={{ width: "21px", height: "26px" }} />
                <span className="admin-text">Logout</span><span style={{color:"#65769C",  marginLeft: "auto"}} >&gt;</span>
              </a>
            </div>
          </div>
        </div>
